...
PATH_TO_PREDICT = os.path.join(ROOT_FOLDER, 'final_result_gt.json')  # Prediction result
PATH_TO_RESULT = os.path.join(ROOT_FOLDER, 'result_table_gt')
