...
CRAFT = None
correct = 1983
OCR_FLOW2 = r'E:\TableBank-Recognition\Recognition\flow2_ocr.txt'
...
if __name__ == '__main__':
    with open(r'E:\TableBank-Recognition\Recognition\flow2_unknown.txt') as file_list:
        remaining_files = file_list.readlines()
        remaining_files = [x.strip() for x in remaining_files]
        CRAFT = craft_wrapper.CRAFT_pytorch()
        with open(r'E:\TableBank-Recognition\Recognition\flow2_ocr2.txt', 'w') as f2_ocr2:
