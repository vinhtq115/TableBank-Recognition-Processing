...
file_list = open(r'E:\TableBank-Recognition\Recognition\flow1_ocr.txt', 'w')
...
for root, dirs, files in os.walk(PATH_TO_IMAGE_FOLDER):
    ...
    for file in files:
        ...
        original_annotation_xml = os.path.join(PATH_TO_ORIGINAL_ANNOTATIONS, name + '.txt')
        ...
        if matched:
            ...
            file_list.write(get_file_name(file))
        else:
            incorrect += 1
